...
#define MAX_PINCOUNT 24
#define EXERCISE_PINCOUNT 22
#define QUERY_PINCOUNT 22
...
byte extraPins[] = { power14, power16, power20, power24, power28, 0 }; // 0 marks end of array
